...
const BentoTilt = ({ children, className = "" }) => {
  ...
  return <div onMouseLeave={handleMouseLeave} onMouseMove={handleMouseMove} ref={itemRef} className={className} style={{transform: transformStyle}}>
    ...
    <section className="bg-black pb-52">
      <div className="container mx-auto px-3 md:px-10">
        <div className="px-5 py-32">
          ...
          <p className="max-w-md text-blue-50 font-circular-web opacity-50">
        ...
        <div className="grid h-[135vh] grid-cols-2 grid-rows-3 gap-7">
          ...
          <BentoTilt className="bento-tilt_1 row-span-1 md:col-span-1 ms-32 md:ms-0">
            <BentoCard
              ...
              description="The player portal uniting humans & AI to play, earn and showcase-gamifying social and Web3 experiences."
            />
          </BentoTilt>
